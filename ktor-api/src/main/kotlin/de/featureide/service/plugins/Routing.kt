        ...
        post("/convert") {
            ...
            try {
                ...
                if (e.requestNumber < 0) {
                    ...
                    call.respond(HttpStatusCode.InternalServerError, "A file from request ${e.requestNumber} could not be added to the database.")
                }
            } catch (e: CouldNotCreateFileException){
                call.respond(HttpStatusCode.InternalServerError, "A request from request ${e.requestNumber} could not be added to the database.")
            }
        }
    }
}
